...
#S_SARG_RAISE0
(SPR_SARG, 13, 1, A_FadeOut, S_SARG_RAISE1),
#S_SARG_RAISE1
(SPR_SARG, 13, 5, None, S_SARG_RAISE2),
#S_SARG_RAISE2
(SPR_SARG, 12, 5, None, S_SARG_RAISE3),
#S_SARG_RAISE3
(SPR_SARG, 11, 5, None, S_SARG_RAISE4),
#S_SARG_RAISE4
(SPR_SARG, 10, 5, None, S_SARG_RAISE5),
#S_SARG_RAISE5
(SPR_SARG, 9, 5, None, S_SARG_RAISE6),
#S_SARG_RAISE6
(SPR_SARG, 8, 5, None, S_SARG_RUN1),
...
#S_FATT_RAISE1
(SPR_FATT, 14, 5, None, S_FATT_RAISE2),
#S_FATT_RAISE2
(SPR_FATT, 13, 5, None, S_FATT_RAISE3),
#S_FATT_RAISE3
(SPR_FATT, 12, 5, None, S_FATT_RAISE4),
#S_FATT_RAISE4
(SPR_FATT, 11, 5, None, S_FATT_RAISE5),
#S_FATT_RAISE5
(SPR_FATT, 10, 5, None, S_FATT_RAISE6),
#S_FATT_RAISE6
(SPR_FATT, 9, 5, None, S_FATT_RUN1),
...
#S_POSS1_RAISE1
(SPR_POSS, 11, 5, None, S_POSS1_RAISE2),
#S_POSS1_RAISE2
(SPR_POSS, 10, 5, None, S_POSS1_RAISE3),
#S_POSS1_RAISE3
(SPR_POSS, 9, 5, None, S_POSS1_RAISE4),
#S_POSS1_RAISE4
(SPR_POSS, 8, 5, None, S_POSS1_RAISE5),
#S_POSS1_RAISE5
(SPR_POSS, 7, 5, None, S_POSS1_RUN1),
...
(SPR_POSS, 20, -1, None, S_NULL),
#S_POSS2_RAISE1
(SPR_POSS, 11, 5, None, S_POSS2_RAISE2),
#S_POSS2_RAISE2
(SPR_POSS, 10, 5, None, S_POSS2_RAISE3),
#S_POSS2_RAISE3
(SPR_POSS, 9, 5, None, S_POSS2_RAISE4),
#S_POSS2_RAISE4
(SPR_POSS, 8, 5, None, S_POSS2_RAISE5),
#S_POSS2_RAISE5
(SPR_POSS, 7, 5, None, S_POSS2_RUN1),
...
#S_TROO_RAISE1
(SPR_TROO, 15, 6, None, S_TROO_RAISE2),
#S_TROO_RAISE2
(SPR_TROO, 14, 6, None, S_TROO_RAISE3),
#S_TROO_RAISE3
(SPR_TROO, 13, 6, None, S_TROO_RAISE4),
#S_TROO_RAISE4
(SPR_TROO, 12, 8, None, S_TROO_RAISE5),
#S_TROO_RAISE5
(SPR_TROO, 11, 8, None, S_TROO_RUN1),
...
#S_HEAD_RAISE1
(SPR_HEAD, 12, 8, None, S_HEAD_RAISE2),
#S_HEAD_RAISE2
(SPR_HEAD, 11, 8, None, S_HEAD_RAISE3),
#S_HEAD_RAISE3
(SPR_HEAD, 10, 8, None, S_HEAD_RAISE4),
#S_HEAD_RAISE4
(SPR_HEAD, 9, 8, None, S_HEAD_RAISE5),
#S_HEAD_RAISE5
(SPR_HEAD, 8, 8, None, S_HEAD_RAISE6),
#S_HEAD_RAISE6
(SPR_HEAD, 7, 8, None, S_HEAD_RUN1),
...
#S_BOSS1_RAISE1
(SPR_BOSS, 13, 8, None, S_BOSS1_RAISE2),
#S_BOSS1_RAISE2
(SPR_BOSS, 12, 8, None, S_BOSS1_RAISE3),
#S_BOSS1_RAISE3
(SPR_BOSS, 11, 8, None, S_BOSS1_RAISE4),
#S_BOSS1_RAISE4
(SPR_BOSS, 10, 8, None, S_BOSS1_RAISE5),
#S_BOSS1_RAISE5
(SPR_BOSS, 9, 8, None, S_BOSS1_RAISE6),
#S_BOSS1_RAISE6
(SPR_BOSS, 8, 8, None, S_BOSS1_RUN1),
...
(SPR_BOSS, 13, -1, None, S_NULL),
#S_BOSS2_RAISE1
(SPR_BOSS, 13, 8, None, S_BOSS2_RAISE2),
#S_BOSS2_RAISE2
(SPR_BOSS, 12, 8, None, S_BOSS2_RAISE3),
#S_BOSS2_RAISE3
(SPR_BOSS, 11, 8, None, S_BOSS2_RAISE4),
#S_BOSS2_RAISE4
(SPR_BOSS, 10, 8, None, S_BOSS2_RAISE5),
#S_BOSS2_RAISE5
(SPR_BOSS, 9, 8, None, S_BOSS2_RAISE6),
#S_BOSS2_RAISE6
(SPR_BOSS, 8, 8, None, S_BOSS2_RUN1),
...
#S_BSPI_RAISE1
(SPR_BSPI, 11, 5, None, S_BSPI_RAISE2),
#S_BSPI_RAISE2
(SPR_BSPI, 10, 5, None, S_BSPI_RAISE3),
#S_BSPI_RAISE3
(SPR_BSPI, 9, 5, None, S_BSPI_RAISE4),
#S_BSPI_RAISE4
(SPR_BSPI, 8, 5, None, S_BSPI_RAISE5),
#S_BSPI_RAISE5
(SPR_BSPI, 7, 5, None, S_BSPI_RAISE6),
#S_BSPI_RAISE6
(SPR_BSPI, 6, 5, None, S_BSPI_RUN1),
...
#S_CPOS_RAISE1
(SPR_CPOS, 13, 5, None, S_CPOS_RAISE2),
#S_CPOS_RAISE2
(SPR_CPOS, 12, 5, None, S_CPOS_RAISE3),
#S_CPOS_RAISE3
(SPR_CPOS, 11, 5, None, S_CPOS_RAISE4),
#S_CPOS_RAISE4
(SPR_CPOS, 10, 5, None, S_CPOS_RAISE5),
#S_CPOS_RAISE5
(SPR_CPOS, 9, 5, None, S_CPOS_RAISE6),
#S_CPOS_RAISE6
(SPR_CPOS, 8, 5, None, S_CPOS_RAISE7),
#S_CPOS_RAISE7
(SPR_CPOS, 7, 5, None, S_CPOS_RUN1),
...
#S_SKEL_RAISE1
(SPR_SKEL, 16, 6, None, S_SKEL_RAISE2),
#S_SKEL_RAISE2
(SPR_SKEL, 15, 6, None, S_SKEL_RAISE3),
#S_SKEL_RAISE3
(SPR_SKEL, 14, 6, None, S_SKEL_RAISE4),
#S_SKEL_RAISE4
(SPR_SKEL, 13, 6, None, S_SKEL_RAISE5),
#S_SKEL_RAISE5
(SPR_SKEL, 12, 6, None, S_SKEL_RAISE6),
#S_SKEL_RAISE6
(SPR_SKEL, 11, 6, None, S_SKEL_RUN1),
...
#S_SPID_PAIN2
(SPR_SPID, 9, 4, A_Pain, S_SPID_RUN1),
#S_SPID_DIE1
(SPR_SPID, 10, 16, A_SpidDeathEvent, S_SPID_DIE2),
#S_SPID_DIE2
(SPR_SPID, 11, 6, A_Fall, S_SPID_DIE3),
#S_SPID_DIE3
(SPR_SPID, 12, 6, None, S_SPID_DIE4),
#S_SPID_DIE4
(SPR_SPID, 13, 6, None, S_SPID_DIE5),
#S_SPID_DIE5
...
#S_FIRE1
(SPR_VFIR, 32768, 0, None, S_FIRE2),
#S_FIRE2
(SPR_VFIR, 32768, 2, A_StartFire, S_FIRE3),
#S_FIRE3
(SPR_VFIR, 32769, 2, A_Fire, S_FIRE4),
#S_FIRE4
(SPR_VFIR, 32768, 2, A_Fire, S_FIRE5),
#S_FIRE5
(SPR_VFIR, 32769, 2, A_Fire, S_FIRE6),
#S_FIRE6
(SPR_VFIR, 32770, 2, A_FireCrackle, S_FIRE7),
#S_FIRE7
(SPR_VFIR, 32769, 2, A_Fire, S_FIRE8),
#S_FIRE8
(SPR_VFIR, 32770, 2, A_Fire, S_FIRE9),
#S_FIRE9
(SPR_VFIR, 32769, 2, A_Fire, S_FIRE10),
#S_FIRE10
(SPR_VFIR, 32770, 2, A_Fire, S_FIRE11),
#S_FIRE11
(SPR_VFIR, 32771, 2, A_Fire, S_FIRE12),
#S_FIRE12
(SPR_VFIR, 32770, 2, A_Fire, S_FIRE13),
#S_FIRE13
(SPR_VFIR, 32771, 2, A_Fire, S_FIRE14),
#S_FIRE14
(SPR_VFIR, 32770, 2, A_Fire, S_FIRE15),
#S_FIRE15
(SPR_VFIR, 32771, 2, A_Fire, S_FIRE16),
#S_FIRE16
(SPR_VFIR, 32772, 2, A_Fire, S_FIRE17),
#S_FIRE17
(SPR_VFIR, 32771, 2, A_Fire, S_FIRE18),
#S_FIRE18
(SPR_VFIR, 32772, 2, A_Fire, S_FIRE19),
#S_FIRE19
(SPR_VFIR, 32771, 2, A_Fire, S_FIRE20),
#S_FIRE20
(SPR_VFIR, 32772, 2, A_FireCrackle, S_FIRE21),
#S_FIRE21
(SPR_VFIR, 32773, 2, A_Fire, S_FIRE22),
#S_FIRE22
(SPR_VFIR, 32772, 2, A_Fire, S_FIRE23),
#S_FIRE23
(SPR_VFIR, 32773, 2, A_Fire, S_FIRE24),
#S_FIRE24
(SPR_VFIR, 32772, 2, A_Fire, S_FIRE25),
#S_FIRE25
(SPR_VFIR, 32773, 2, A_Fire, S_FIRE26),
#S_FIRE26
(SPR_VFIR, 32774, 2, A_Fire, S_FIRE27),
#S_FIRE27
(SPR_VFIR, 32775, 2, A_Fire, S_FIRE28),
#S_FIRE28
(SPR_VFIR, 32774, 2, A_Fire, S_FIRE29),
#S_FIRE29
(SPR_VFIR, 32775, 2, A_Fire, S_FIRE30),
#S_FIRE30
(SPR_VFIR, 32774, 2, A_Fire, S_FIRE31),
#S_FIRE31
(SPR_VFIR, 32775, 2, A_Fire, S_NULL),
...
#S_VILE_ATK11
(SPR_VILE, 32783, 8, None, S_VILE_ATK12),
#S_VILE_ATK12
(SPR_VILE, 32784, 12, None, S_VILE_RUN1),
#S_VILE_HEAL1
(SPR_VILE, 32793, 10, None, S_VILE_HEAL2),
#S_VILE_HEAL2
(SPR_VILE, 32794, 10, None, S_VILE_HEAL3),
#S_VILE_HEAL3
(SPR_VILE, 32795, 10, None, S_VILE_RUN1),
#S_VILE_PAIN
(SPR_VILE, 17, 5, None, S_VILE_PAIN2),
#S_VILE_PAIN2
(SPR_VILE, 17, 5, A_Pain, S_VILE_RUN1),
#S_VILE_DIE1
(SPR_VILE, 18, 7, None, S_VILE_DIE2),
#S_VILE_DIE2
(SPR_VILE, 19, 7, A_Scream, S_VILE_DIE3),
#S_VILE_DIE3
(SPR_VILE, 20, 7, A_Fall, S_VILE_DIE4),
#S_VILE_DIE4
(SPR_VILE, 21, 7, None, S_VILE_DIE5),
#S_VILE_DIE5
(SPR_VILE, 22, 7, None, S_VILE_DIE6),
#S_VILE_DIE6
(SPR_VILE, 23, 7, A_OnDeathTrigger, S_VILE_DIE7),
#S_VILE_DIE7
(SPR_VILE, 24, -1, None, S_NULL),
...
#S_HEAD_RAISE6
(SPR_TEST, 12, 8, None, S_TEST_RAISE5),
#S_HEAD_RAISE5
(SPR_TEST, 11, 8, A_OnDeathTrigger, S_TEST_RAISE4),
#S_HEAD_RAISE4
(SPR_TEST, 10, 8, A_Fall, S_TEST_RAISE3),
#S_HEAD_RAISE3
(SPR_TEST, 9, 8, None, S_TEST_RAISE2),
#S_HEAD_RAISE2
(SPR_TEST, 8, 8, A_Scream, S_TEST_RAISE1),
#S_HEAD_RAISE1
(SPR_TEST, 7, 8, None, S_TEST_RUN1),
])
